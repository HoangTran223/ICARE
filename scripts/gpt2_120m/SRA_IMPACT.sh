...
# Fixed per user request (effective batch 8 = 4 x 2 x 1)
BATCH_SIZE=4
LR=0.0005
GRAD_ACC=4
EVAL_BATCH_SIZE=8
...
# SRA (SRA paper Table 9: alpha=0.5, geom=50, p=1.0, tau=2; last layer -1/-1)
# Log ...alpha=0.7__geom^w=100...: rougeL peak 24.70 @ ep12 (ep15–16 ~24.5).
# Smaller student benefits from higher CE weight (alpha) vs paper 340M default.
SRA_ALPHA=0.2
SRA_GEOM_WEIGHT=100.0
SRA_SPAN_POWER=1.0
SRA_STUDENT_LAYERS="-1"
SRA_TEACHER_LAYERS="-1"
SRA_HIDDEN_LOSS_WEIGHTS="1.0"

# IMPACT: same run as above (impact_lambda=5, top_k=4, bi_tau=2); impact_loss ~0.004 vs logit_kd ~0.88 early.
IMPACT_LAMBDA=10.0
IMPACT_TOP_K=10
IMPACT_BI_TAU=2.0
...
# model dims (GPT2-120M: 768, Qwen1.5-1.8B: 2048)
