#!/bin/bash
# ResidualKD_IMPACT Full Pipeline: Stage 1 (Pretrain) + Stage 2 (Finetune with IMPACT)
# Usage: bash scripts/anhtue/may4/ResidualKD_IMPACT_full.sh
set -e
...
S1_OPTS+=" --teacher-peft-path ${TEACHER_PEFT_PATH}"
...
# ============================================================
# Stage 2: Residual Knowledge Distillation + IMPACT
# ============================================================
echo "============================================================"
echo "Stage 2: Residual Knowledge Distillation + IMPACT"
echo "============================================================"
...
S2_LR=0.001
S2_GRAD_ACC=1
S2_EVAL_BATCH_SIZE=8
S2_EPOCH=15
LAMBDA_RES=0.9
LAMBDA_WARMUP=50
PROJECTOR_LR=0.001
PROJECTOR_LOAD_PATH="${S1_SAVE_PATH}/projector_best.pt"
CRITERION="ResidualKD_IMPACT"

S2_CONFIG="${CRITERION}-lora-rank=${LORA_RANK}-alpha=${LORA_ALPHA}-dropout=${LORA_DROPOUT}-${PRECISION}"
...
S2_SAVE_PATH="${BASE_PATH}/outputs/${CKPT_NAME}/ResidualKD_IMPACT/${S2_SETTING}"
...
S2_OPTS+=" --teacher-peft-path ${TEACHER_PEFT_PATH}"
...
S2_OPTS+=" --task ResidualKD_IMPACT"
S2_OPTS+=" --lr ${S2_LR}"
...
S2_OPTS+=" --peft lora"
S2_OPTS+=" --peft-lora-r ${LORA_RANK}"
S2_OPTS+=" --peft-lora-alpha ${LORA_ALPHA}"
S2_OPTS+=" --peft-lora-dropout ${LORA_DROPOUT}"
...
# IMPACT
S2_OPTS+=" --impact-lambda ${IMPACT_LAMBDA}"
S2_OPTS+=" --impact-top-k ${IMPACT_TOP_K}"
S2_OPTS+=" --impact-bi-tau ${IMPACT_BI_TAU}"
S2_OPTS+=" --impact-lambda-reg ${IMPACT_LAMBDA_REG}"
...
echo ""
echo "============================================================"
echo "ResidualKD_IMPACT Full Pipeline Completed!"
